...
protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.about);
        ...
        CardView regTech = findViewById(R.id.RegTech);
        regTech.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent techReg = new Intent(AboutActivity.this, TechRegActivity.class);
                startActivity(techReg);
            }
        });
        CardView settings = findViewById(R.id.set);
...
//        GlideApp.with(this).load(url).into(imgProfile);
    ...
    private void loadProfileDefault() {
        //GlideApp.with(this).load(R.drawable.ic_baseline_account_circle_24)
          //      .into(imgProfile);
    ...
    private void launchCameraIntent() {
        Intent intent = new Intent(AboutActivity.this, ImagePickerActivity.class);
