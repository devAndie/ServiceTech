...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    public static void showImagePickerOptions(SettingsActivity context, PickerOptionListener listener) {
     ...
     * @param context
     */
    public static void clearCache(SettingsActivity context) {
